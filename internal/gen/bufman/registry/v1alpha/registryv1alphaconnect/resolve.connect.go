...
const (
	...
	ResolveServiceName = "bufman.registry.v1alpha.ResolveService"
)
...
const (
	...
	// GetModulePins RPC.
	ResolveServiceGetModulePinsProcedure = "/bufman.registry.v1alpha.ResolveService/GetModulePins"
)

// ResolveServiceClient is a client for the bufman.registry.v1alpha.ResolveService service.
...
// NewResolveServiceClient constructs a client for the bufman.registry.v1alpha.ResolveService
...
// GetModulePins calls bufman.registry.v1alpha.ResolveService.GetModulePins.
...
// ResolveServiceHandler is an implementation of the bufman.registry.v1alpha.ResolveService service.
...
func NewResolveServiceHandler(svc ResolveServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/bufman.registry.v1alpha.ResolveService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResolveServiceHandler) GetModulePins(context.Context, *connect_go.Request[v1alpha.GetModulePinsRequest]) (*connect_go.Response[v1alpha.GetModulePinsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("bufman.registry.v1alpha.ResolveService.GetModulePins is not implemented"))
}
